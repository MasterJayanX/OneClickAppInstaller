...
private:
    ...
    void loadTranslations(const string& language) {
        if (language == "en") {
            ...
            translations["nonvalid"] = "Invalid option.";
            ...
            translations["about1"] = "OneClickAppInstaller is a simple command line tool that allows you to create a script to install all your applications on Windows, macOS or Linux automatically with just one click.";
            translations["about2"] = "This tool was created by MasterJayanX.";
            translations["about3"] = "Version: 1.1.0 (2023-12-18)";
            translations["about4"] = "Check out the full changelog here: https://github.com/MasterJayanX/OneClickAppInstaller/releases";
            translations["presskey"] = "Press Enter to exit...";
        } 
        else if (language == "es") {
            ...
            translations["nonvalid"] = "Opción no válida.";
            ...
            translations["about3"] = "Versión: 1.1.0 (2023-12-18)";
            ...
            translations["presskey"] = "Presiona Enter para salir...";
        }
    }
};