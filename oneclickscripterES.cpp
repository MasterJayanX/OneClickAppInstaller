...
int main(){
    ...
    string nombre;
    string update;
    cout << "Bienvenido a OneClickAppInstaller, un software que te permite crear un script de instalación de aplicaciones para Windows o Linux (Ubuntu/Debian) con un solo clic." << endl;
